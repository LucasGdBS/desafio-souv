...
export default function Card({ image, date, title, description }: CardProps) {
  return (
    <article className="flex flex-col space-y-4 max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl">
      ...
      <div className="flex flex-col space-y-4">
        ...
        <h2 className="text-custom-purple font-bold text-xl sm:text-2xl">{title}</h2>
